...
## Clicking a notification popup now opens the work item, not just closes the popup
...
## Added an "open in new tab" button to the work item side panel, instead of hiding it in the menu
