    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/layout.tsx", [
          ...
          // Work item templates
          layout("./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/templates/layout.tsx", [
            route(
              ":workspaceSlug/projects/:projectId/templates",
              "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/templates/page.tsx"
            ),
          ]),
      ...
      layout("./(all)/[workspaceSlug]/(settings)/layout.tsx", [
        ...
        layout("./(all)/[workspaceSlug]/(settings)/settings/projects/layout.tsx", [
          ...
          layout("./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/layout.tsx", [
            ...
            route(
              ":workspaceSlug/settings/projects/:projectId/features/templates",
              "./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/features/templates/page.tsx"
            ),
            // Project States
            route(
