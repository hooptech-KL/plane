...
export default {
  ...
  templates_description: "Start work items from pre-filled formats your team reuses.",
  ...
  project_settings: {
    ...
    features: {
      ...
      templates: {
        ...
        toggle_title: "Enable templates",
        toggle_description: "Project members will be able to create work items from templates.",
      },
    },
  },
  work_item_templates: {
    ...
    empty_state: "No templates yet. Create one to pre-fill new work items.",
    form: {
      name_placeholder: "Template name",
      description_placeholder: "What is this template for?",
      defaults_title: "Work item defaults",
      title_placeholder: "Default title",
      body_placeholder: "Default description",
    },
    toast: {
