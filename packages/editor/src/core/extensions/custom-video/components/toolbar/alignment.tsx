...
import { VIDEO_ALIGNMENT_OPTIONS } from "../../utils";

type Props = {
  activeAlignment: TCustomVideoAlignment;
  handleChange: (alignment: TCustomVideoAlignment) => void;
  isTouchDevice: boolean;
  toggleToolbarViewStatus: (val: boolean) => void;
};

export function VideoAlignmentAction(props: Props) {
  ...
  // derived values
  const activeAlignmentDetails = VIDEO_ALIGNMENT_OPTIONS.find((option) => option.value === activeAlignment);
